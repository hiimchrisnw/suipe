...
export function SwipeCard({ swipe, onSelect }: SwipeCardProps) {
  ...
  return (
    ...
    >
      ...
      {swipe.tags.length > 0 && (
        <div className="pointer-events-none absolute inset-0 hidden rounded-lg bg-gradient-to-t from-black/70 via-black/25 to-transparent opacity-0 transition-opacity duration-200 md:block md:group-hover:opacity-100">
